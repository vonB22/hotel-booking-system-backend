    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                ...
                <p class="mb-0">Update role information and permissions</p>
            </div>
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            <form method="POST" action="{{ route('roles.update', $role->id) }}" id="editRoleForm">
                ...
                <!-- Role ID Badge -->
                <div class="role-id-badge">
                    <i class="fa-solid fa-hashtag"></i>
                    <div class="role-id-badge-content">
                        <div class="role-id-label">Role ID</div>
                        <div class="role-id-value">#{{ $role->id }}</div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="info-badge">
                            ...
                            <div class="info-badge-content">
                                ...
                                <p class="info-badge-text">Update the permissions for this role. Changes will affect all users assigned to this role.</p>
                            </div>
                        </div>
