    ...
    <div id="app">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                ...
                @php
                $showCentered = !(request()->routeIs('login') || request()->routeIs('register'));
                ...
                <div class="collapse navbar-collapse justify-content-center" id="mainNavbar">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item px-2"><a class="nav-link" href="{{ route('products.index') }}">Hotels</a>
                        </li>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link btn btn-sm btn-primary text-white px-3"
