...
<div class="container-fluid px-3">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                ...
                <p class="mb-0">Fill in the booking details below</p>
            </div>
    ...
    <!-- Create Booking Form -->
    <form method="POST" action="{{ route('bookings.store') }}" id="createBookingForm">
        @csrf
            ...
            <div class="form-card-body">
                <div class="info-badge">
                    ...
                    <div class="info-badge-content">
                        <div class="info-badge-title">Select a Hotel</div>
                        <p class="info-badge-text">Choose the hotel for this reservation. This field is optional.</p>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <small class="text-muted d-block mt-1" style="font-size: 0.7rem;">
                            ...
                            You can leave this empty if hotel is not yet assigned
                        </small>
                        @error('product_id')
            ...
            <div class="form-card-body">
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <small class="text-muted d-block mt-1" style="font-size: 0.7rem;">
                            <i class="fa-solid fa-info-circle me-1"></i>
                            Optional: Add any special requirements or preferences
                        </small>
                    </div>
                </div>
            </div>
...
<script>
    ...
    // Initialize calculation if old values exist
